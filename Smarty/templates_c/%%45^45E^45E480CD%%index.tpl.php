<?php /* Smarty version 2.6.19, created on 2016-12-17 02:46:58
      ...
      <div class="row pro-list">
        ...
        <div class="pro-list-r">
          <div class="pro-list-title">
              <?php echo $this->_tpl_vars['lang']['Food']; ?>
                ...
                <p><?php echo $this->_tpl_vars['lang']['JointTests_C']; ?>
</p>
          </div>
          ...
          <div class="pro-list-content">
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['milkpowder']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['MilkPowder']; ?>
</div>
              </div>
            </div>
              </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['milk']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Milk']; ?>
</div>
              </div>
            </div>
              </a>
        ...
        <div class="pro-list-l">
          <div class="pro-list-title">
              ...
              <p><?php echo $this->_tpl_vars['lang']['JointTests']; ?>
</p>
          </div>
          <div class="pro-list-content">
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['mobilephones']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['tvs']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Televisions']; ?>
</div>
              </div>
            </div>
              </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['tablets']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['basiccameras']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Cameras']; ?>
</div>
              </div>
            </div>
            </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['fitnessbands']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Fitness']; ?>
</div>
              </div>
            </div>
            </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['laptops']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Laptops']; ?>
</div>
              </div>
            </div>
            </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['whheadphones']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Headphones']; ?>
</div>
              </div>
            </div>
            </a>
            ...
            <div class="pro-list-item">
              ...
              <div class="pro-list-item-info">
                <div class="num"><?php echo $this->_tpl_vars['number']['smartwatches']; ?>
</div>
              </div>
              <div class="pro-list-item-info">
                <div class="name"><?php echo $this->_tpl_vars['lang']['Smartwatches']; ?>
</div>
              </div>
            </div>
            </a>
