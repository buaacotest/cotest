<?php /* Smarty version 2.6.19, created on 2016-12-04 10:43:17
...
<!--
    ...
    -->
    <div class="crumbs">
      <a href="index.php"><div class="crumbs-item"><?php echo $this->_tpl_vars['lang']['Tests']; ?>
</a> <sapn>></sapn></div>
      <a href="<?php echo $this->_tpl_vars['directory']['upper']['link']; ?>
"><div class="crumbs-item"><?php echo $this->_tpl_vars['directory']['upper']['name']; ?>
</a> <sapn>></sapn></div>
      <a href="<?php echo $this->_tpl_vars['directory']['up']['link']; ?>
"><div class="crumbs-item"><?php echo $this->_tpl_vars['directory']['up']['name']; ?>
</a> <sapn>></sapn></div>
      <div class="crumbs-item"><?php echo $this->_tpl_vars['lang']['Comparison']; ?>
</div>
        ...
        <thead class="product-head">
          ...
          <tr class="product-images">
            <th class="edit-comparison" scope="row" rowspan="2">
                ...
                <button class="add-compare-btn" title="return to smartphones">+<?php echo $this->_tpl_vars['lang']['Add']; ?>
</button>
...
/picturesx/<?php echo $this->_tpl_vars['products'][$this->_sections['n']['index']]['id']; ?>
_01x.jpg">
                </a>
                <div class="close" target-name="<?php echo $this->_tpl_vars['products'][$this->_sections['n']['index']]['name']; ?>
" target-id="<?php echo $this->_tpl_vars['products'][$this->_sections['n']['index']]['id']; ?>
"></div>
              </div>
...
$this->_sections['n']['last']       = ($this->_sections['n']['iteration'] == $this->_sections['n']['total']);
?>
              <th class="product-name"><?php echo $this->_tpl_vars['products'][$this->_sections['n']['index']]['manufacturer']; ?>
...
?>
                <td data-product-id="10344" class="behind-paywall">
                          ...
                          <?php if ($this->_tpl_vars['products'][$this->_sections['m']['index']]['property'][$this->_sections['k']['index']]['id_propertygroup'][$this->_sections['n']['index']]['value'] == 'Yes'): ?>
                            ...
                            <?php elseif ($this->_tpl_vars['products'][$this->_sections['m']['index']]['property'][$this->_sections['k']['index']]['id_propertygroup'][$this->_sections['n']['index']]['value'] == 'No'): ?>
...
//关闭响应事件
$(".compare-title").text(compare_list.length+" <?php echo $this->_tpl_vars['directory']['up']['name']; ?>
 in comparison".toLowerCase())
//toggle
...
$(".add-compare-btn").on("click",function(){
  var url="products.php?proj=<?php echo $this->_tpl_vars['project']; ?>
"
...
$(".product-link").on("click",function(){
  ...
  var url="details.php?proj=<?php echo $this->_tpl_vars['project']; ?>
&ids="+JSON.stringify(compare_list)+"&names="+JSON.stringify(name_list)+"&id="+id;
 window.location.href=url;
})
  $(function(){
  //获取要定位元素距离浏览器顶部的距离
