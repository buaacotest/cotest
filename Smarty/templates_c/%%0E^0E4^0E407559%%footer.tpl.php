<?php /* Smarty version 2.6.19, created on 2017-02-10 01:47:19
      ...
      <div class="row footer-container">
        ...
        <div class="footer-block">
         ...
         <!-- <ul class="join-list">
            ...
            -->
            <li><a href="impressum.php"> <?php echo $this->_tpl_vars['lang']['Impressum']; ?>
</a></li>
            <li><a href="terms.php"> <?php echo $this->_tpl_vars['lang']['ServiceAgreement']; ?>
</a></li>

            <!--<h4><b><?php echo $this->_tpl_vars['lang']['ContactUs']; ?>
</b></h4>-->
            <br>
