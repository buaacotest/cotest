...
function showLabels(){
    $labels=<<<EOF
[{"type":"range","name":"total test result","label":"Total test result","value":[{">=":0,"<=":1.5},{">":1.5,"<=":2.5},{">":2.5,"<=":3.5},{">":3.5,"<=":4.5},{">":4.5,"<=":5.5}],"option":["very good ","good ","average","sufficient","poor"],"number":["0","10","7","0","0"]},{"type":"date","name":"Publication date","label":"Tested date","value":[2016,2015,2014],"option":[2016],"number":["17","0","0"]},{"type":"string","name":"Brand","label":"Brands","value":["Garmin","Fitbit","Pebble","Polar","Alcatel","Asus","Runtastic","Withings","Microsoft","Samsung","Misfit"],"option":["Garmin","Fitbit","Pebble","Polar","Alcatel","Asus","Runtastic","Withings","Microsoft","Samsung","Misfit"],"number":["4","2","2","2","1","1","1","1","1","1","1"]},{"type":"multi","name":"","label":"Key features","value":["Backlit screen (y,n)","Touch sensitive screen (y,n)","NFC (y,n)","  * Make\/receive phone calls? (y,n)","Integrated heart monitor present? (y,n)","Water resistant (y,n)"],"option":["Backlit screen","Touch screen","NFC","Make\/receive calls","Heart rate monitor","Water resistant"],"number":["12","11","2","2","8","12"]},{"type":"multi","name":"","label":"Phone compatibility","value":["Connects to Android phone (y,n)","Connects to iOS phone (y,n)"],"option":["Android","Apple iPhone"],"number":["17","16"]}]
EOF;
